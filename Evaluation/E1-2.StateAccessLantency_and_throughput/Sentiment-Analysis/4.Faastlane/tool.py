...
class TimeStatistics:
    ...
    def add_access_time(self, start_time):
        self.access_time += (1000 * time.time() - start_time)
    ...
    def from_list(self, l1: list):
        self.exec_time = l1[0]
        self.invoke_time = l1[1]
        self.access_time = l1[2]
        self.resides_time = l1[3]
